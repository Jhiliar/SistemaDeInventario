                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="ControladorCompras?accion=listarCompras"><i class="fa fa-address-card"></i>Compras</a></li>     </ul>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        ...
                        <form class="form-horizontal" action="ControladorUsuario?accion=registrar" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Nombre Usuario</label>
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <input id="nombre" type="text" class="form-control" placeholder="Inserte Usuario" name="txtNombre" maxlength="10"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="nombre" type="password" class="form-control" placeholder="Inserte codigo" name="txtClave" maxlength="10"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
...
<%
        ...
        response.sendRedirect("Ingresos Sistema.jsp");
    }
%>
