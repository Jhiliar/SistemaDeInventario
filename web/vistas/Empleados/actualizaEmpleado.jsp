        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>Sistema Inventarios</b></span>
                </a>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            <a href="#"><i class="glyphicon glyphicon-th-large"></i> <span>Registros cris</span>
                        ...
                        <li class="treeview">
                            <a href="#"><i class="fa fa-cart-arrow-down"></i> <span>Empleados</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-cart-arrow-down"></i>Nueva Empleado</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10 col-md-5 ">
                            <div class="btn-group pull-right">
                                <a href="ControladorUsuario?accion=listarUsuarios" class="btn btn-default">
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            <i class="fa fa-edit"></i> <h3 class="box-title">Actualizar Datos</h3>  
                        </div>
                        <form class="form-horizontal" action="ControladorEmpleado?accion=actualizarEmpleado" method="post">
                            <input type="hidden" name="hCodigo" value="${empleados.id}">
                            <div class="box-body">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <input id="nombre" type="text" class="form-control" placeholder="Inserte Cedula de Indentidad" name="txtci" maxlength="60"
                                                   value="${empleados.ci}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Inserte Paterno" name="txtpat" maxlength="60"
                                                   value="${empleados.pat}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Inserte Materno" name="txtmat" maxlength="60"
                                                   value="${empleados.mat}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Inserte Nombre" name="txtnom" maxlength="60"
                                                   value="${empleados.nom}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Inserte Direccion" name="txtdir" maxlength="80"
                                                   value="${empleados.dir}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Inserte Telefono" name="txttel" maxlength="60"
                                                   value="${empleados.tel}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Inserte Email" name="txtemail" maxlength="60"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Inserte Cargo" name="txtcar" maxlength="10"
                                                   value="${empleados.idcar}">
                                        </div>
                                    </div>
                                ...
                                <div class="box-footer">
                                    ...
                                    <button type="submit" id="" name="btnRegistrar" value="Registrar" class="btn btn-success"><i class="fa fa-refresh"></i> Actualizar Empleado</button>
