...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>Sistema de Inventarios</b>La Estrella</span>
                </a>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <a href="ControladorProducto?accion=nuevo" class="btn btn-success">
                            ...
                            <div class="table-responsive" >                                 
                                <table class="table table-bordered table-striped dataTable table-hover" id="tablaProductos" class="display">
                                    ...
                                    <%
                                        ...
                                        CRUD_productos cprod = new CRUD_productos();
                                        prods = cprod.listar();
                                        for (int i = 0; i < prods.size(); i++) {
                                    %>
                                    <tr>
                                        <td><%=prods.get(i).getId()%></td>
                                        <td><%=prods.get(i).getDes()%></td>
                                        <td><%=prods.get(i).getMar()%></td>
                                        <td><%=prods.get(i).getProc()%></td>
                                        <td><%=prods.get(i).getCant()%></td>
                                        <td><%=prods.get(i).getPrec()%></td>

                                        <td>
                                            <input type="hidden" id="codigo" value="<%=prods.get(i).getId()%>">
                                            <a id="deleteProd" class="btn btn-danger" href='ControladorProducto?accion=eliminarProducto&cod=<%=prods.get(i).getId()%>'>
                                                <i class="fa fa-trash"></i>
                                            </a>

                                            <a class="btn btn-warning" href='ControladorProducto?accion=leerProducto&cod=<%=prods.get(i).getId()%>'><i class="fa fa-pencil"></i>
                                            </a>
                                        </td>
        ...
        <script src="js/funcionesProductos1.js" type="text/javascript"></script>
        <script>
