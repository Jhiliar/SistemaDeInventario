                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-cube"></i>Buscador de componentes</a></li>
                                ...
                                <li class="active"><a href="ControladorUsuario?accion=listarUsuarios"><i class="fa fa-address-card"></i>Usuarios</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        ...
                        <form class="form-horizontal" action="ControladorUsuario?accion=actualizarUsuario" method="post">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: Javier" name="txtNombre" maxlength="10"
