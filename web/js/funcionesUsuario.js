$(document).ready(function () {
            ...
            closeOnCancel: false
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        setTimeout(function () {
                            parent.location.href = "ControladorUsuario?accion=listarUsuarios"
                        }, 1800);
                    } else {
    ...
    function eliminarUsuario(cod) {
        var url = "ControladorUsuario?accion=eliminarUsuario&cod=" + cod;
...
$(document).ready(function () {
    ...
    function activarUsuario(cod) {
        var url = "ControladorUsuario?cambiar=activar&cod=" + cod;
...
$(document).ready(function () {
    ...
    function desactivarUsuario(cod) {
        var url = "ControladorUsuario?cambiar=desactivar&cod=" + cod;
