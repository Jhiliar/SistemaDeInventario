<%@page import="Programas.CRUD_empleado"%>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <a href="ControladorEmpleado?accion=nuevo" class="btn btn-success">
                            ...
                            <div class="table-responsive" >                                 
                                <table class="table table-bordered table-striped dataTable table-hover" id="tablaEmpleados" class="display">
                                    ...
                                    <%
                                        ...
                                        List<Empleado> dats = null;
                                        CRUD_empleado cdat = new CRUD_empleado();
                                        dats = cdat.listar();
                                        for (int i = 0; i < dats.size(); i++) {
                                    %>
                                    <tr>
                                        <td><%=dats.get(i).getId()%></td>
                                        <td><%=dats.get(i).getCi()%></td>
                                        <td><%=dats.get(i).getPat()%></td>
                                        <td><%=dats.get(i).getMat()%></td>
                                        <td><%=dats.get(i).getNom()%></td>
                                        <td><%=dats.get(i).getDir()%></td>

                                        <td>
                                            <input type="hidden" id="codigo" value="<%=dats.get(i).getId()%>">
                                            <a id="deleteProd" class="btn btn-danger" href='ControladorEmpleado?accion=eliminarEmpleado&cod=<%=dats.get(i).getId()%>'>
                                                <i class="fa fa-trash"></i>
                                            </a>

                                            <a class="btn btn-warning" href='ControladorEmpleado?accion=leerEmpleado&cod=<%=dats.get(i).getId()%>'><i class="fa fa-pencil"></i>
                                            </a>
                                        </td>
        ...
        <script src="js/funcionesEmpleados1.js" type="text/javascript"></script>
        <script>
