    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
                                ...
                                <table class="table table-bordered" border="1" bordercolor="red">
                                    ...
                                    <tr>
                                        <c:if test="${producto != null}">
                                            ...
                                            <td>${producto.mar}</td>
                                            <td>${producto.proce}</td>
                                            <td>${producto.cant}</td>
                                            <td>${producto.prec}</td>
                                            <td>${producto.stockmax}</td>
                                            <td><img src="${producto.ruta}" width="200" height="200"></td>
                                            </c:if>
                                    </tr>
                                </table>
                            </div>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; 2023 <a href="#"></a>.</strong> Todos los derechos reservados.
            </footer>
...
<%
        ...
        response.sendRedirect("IngresSistema.jsp");
    }
%>
