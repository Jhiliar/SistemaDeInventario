        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>Sistema de Inventario</b>"NeoSis"</span>
                </a>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        ...
                        <form class="form-horizontal" action="ControladorEmpleado?accion=registrar" method="post">
                           //
                            <div class="box-body">
                           ...
                           //
                            ...
                            <div class="box-footer">
                                ...
                                <button type="submit" id="" name="accion" value="registrar" class="btn btn-success"><i class="fa fa-floppy-o"></i> Registrar</button>
