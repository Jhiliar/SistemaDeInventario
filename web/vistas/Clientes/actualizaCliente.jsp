            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview">
                            <a href="#"><i class="fa fa-cart-arrow-down"></i> <span>Clientes</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-cart-arrow-down"></i>Nueva Cliente</a></li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        ...
                        <form class="form-horizontal" action="ControladorCliente?accion=actualizarCliente" method="post">
                            <input type="hidden" name="hCodigo" value="${clientes.id}">
                            <div class="box-body">
                                ...
                                <div class="box-body">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <input id="nombre" type="text" class="form-control" placeholder="Inserte Nit" name="txtnit" maxlength="80"
                                               value="${clientes.nit}">
                                    </div>
                                </div>
                            ...
                            <div class="box-footer">
                                ...
                                <button type="submit" id="" name="btnRegistrar" value="Registrar" class="btn btn-success"><i class="fa fa-refresh"></i> Actualizar Cliente</button>
