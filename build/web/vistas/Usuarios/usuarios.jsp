    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <a href="ControladorUsuario?accion=nuevo" class="btn btn-success">
                                ...
                                <table class="table table-bordered table-striped dataTable table-hover" id="tablaUsuarios" class="display">
                                    ...
                                    <c:forEach var="user" items="${usuarios}" varStatus="iteracion">                                                    
                                        <tr>
                                            ...
                                            <td><a href="<c:url value="ControladorUsuario">
                                                ...
                                                <c:choose>
                                                    <c:when test="${user.estado == true}">
                                                        ...
                                                        <a id="desactivarUsuario" href="ControladorUsuario?cambiar=desactivar&cod=${user.id_usuario}" class="btn btn-danger"  data-toggle="tooltip" title="Desactivar" data-original-title="Desactivar">
                                                            <i class="fa fa-remove"></i></a>
                                                        </c:when>
                                                        <c:otherwise>
                                                        <input type="hidden" id="item" value="${user.id_usuario}">
                                                        <a id="activarUsuario" href="ControladorUsuario?cambiar=activar&cod=${user.id_usuario}" class="btn btn-primary" data-toggle="tooltip" title="Activar" data-original-title="Activar">
                                                            <i class="glyphicon glyphicon-eye-open"></i></a>
                                                        </c:otherwise>
                                                    </c:choose>
                                                <!-- ELIMINAR USUARIOS -->
                                                <input type="hidden" id="codigo" value="${user.id_usuario}">
                                                <a id="deleteUser" href="<c:url value="ControladorUsuario">
