    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <a href="ControladorCliente?accion=nuevo" class="btn btn-success">
                        ...
                        <div class="box-body">
                            <div class="table-responsive" >                                 
                                <table class="table table-bordered table-striped dataTable table-hover" id="tablaEmpleados" class="display">
                                    ...
                                    <%
                                        Cliente dat = new Cliente();
                                        List<Cliente> dats = null;
                                        CRUD_clientes cdat = new CRUD_clientes();
                                        dats = cdat.listar();
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a id="deleteProd" class="btn btn-danger" href='ControladorCliente?accion=eliminarCliente&cod=<%=dats.get(i).getId()%>'>
                                                <i class="fa fa-trash"></i>
                                            </a>

                                            <a class="btn btn-warning" href='ControladorCliente?accion=leerCliente&cod=<%=dats.get(i).getId()%>'><i class="fa fa-pencil"></i>
                                            </a>
                                        </td>
