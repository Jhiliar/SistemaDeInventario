                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-cart-arrow-down"></i>Nueva Proveedor</a></li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        ...
                        <form class="form-horizontal" action="ControladorProveedor?accion=actualizarProveedor" method="post">
                            <input type="hidden" name="hCodigo" value="${proveedor.id}">
                            <div class="box-body">
                            ...
                            <div class="box-footer">
                                ...
                                <button type="submit" id="" name="btnRegistrar" value="Registrar" class="btn btn-success"><i class="fa fa-refresh"></i> Actualizar Proveedor</button>
